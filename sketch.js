    ...
    _p5.setup = () => {
        ...
        button.mousePressed(function () {
            if (!isCounterAnimation) {
                ...
                // _p5.print(totalRows);
                const firstAnimEndPos = counter + height_str * totalRows
                const moveSecondAnimUpOrDown = Math.random() < 0.5 ? counter - 50 : counter + 50
                const secondAnimEndPos = moveSecondAnimUpOrDown + height_str * totalRows
                const moveThirddAnimUpOrDown = Math.random() < 0.5 ? counter - 800 : counter + 800
                const thirdAnimEndPos = moveThirddAnimUpOrDown + height_str * totalRows
